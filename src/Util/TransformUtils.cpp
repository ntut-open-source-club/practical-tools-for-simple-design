...
Core::Matrices ConvertToUniformBufferData(const Util::Transform &transform,
    ...
    auto view =
        glm::scale(eye, {1.F / PTSD_Config::WINDOW_WIDTH, 1.F / PTSD_Config::WINDOW_HEIGHT, 1.F}) *
        glm::translate(eye, {PTSD_Config::WINDOW_WIDTH / 2, PTSD_Config::WINDOW_HEIGHT / 2, 0});
