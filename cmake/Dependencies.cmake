...
FetchContent_Declare(
    ...
    SOURCE_DIR  ${PTSD_DIR}/lib/sdl2_image
)
...
FetchContent_Declare(
    ...
    SOURCE_DIR  ${PTSD_DIR}/lib/sdl2_ttf
)
FetchContent_Declare(
        sdl2_mixer
        ...
        SOURCE_DIR  ${PTSD_DIR}/lib/sdl2_mixer
)
...
FetchContent_Declare( # At this time 1.11.0 has some issues formatting `const unsigned char *`
    ...
    SOURCE_DIR  ${PTSD_DIR}/lib/spdlog
)
...
FetchContent_Declare(
    ...
    SOURCE_DIR  ${PTSD_DIR}/lib/googletest
)
...
if (NOT ${glew_POPULATED})
    ...
    add_subdirectory(${PTSD_DIR}/lib/glew/build/cmake)
endif()
...
set(DEPENDENCY_LINK_LIBRARIES ${PTSD_DIR} PARENT_SCOPE)

set(DEPENDENCY_INCLUDE_DIRS
    ${PTSD_DIR}/lib/sdl2/include/
    ${PTSD_DIR}/lib/glew/include/
    ${PTSD_DIR}/lib/spdlog/include/
    ${PTSD_DIR}/lib/glm/
)
set(DEPENDENCY_INCLUDE_DIRS ${PTSD_DIR} PARENT_SCOPE)
